                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Update <strong>{{$user->name}}</strong></h1>
                            </div>
                            <form class="user" action="{{ route('users.update',$user->id)}}" method="POST">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user @error('name') is-invalid @enderror" name="name" value="{{$user->name}}"  id="exampleFirstName"
                                            placeholder="User Name" name="name">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control form-control-user @error('phone') is-invalid @enderror"  value="{{ $user->phone }}" id="exampleLastName"
                                            placeholder="Phone Number" name="phone">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-user @error('email') is-invalid @enderror"  value="{{ $user->email }}" id="exampleInputEmail"
